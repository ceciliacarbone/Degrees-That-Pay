    ...
    navlistPanel(
        ...
        tabPanel(title = "About", h3("About Degrees That Pay Data"),
                                     ...
                                     p("This data set will explore which undergradratue majors will generate the highest paying salary.
                                       ...
                                       br(),
                                       p("This data was obtained from Kaggle.com and all data was obtained from the Wall Street Journal based on data from Payscale, Inc. in 2017"),
                                       br(),
                                       p("*Please make note that all bar chart and scatter plot legands are interactive"),
